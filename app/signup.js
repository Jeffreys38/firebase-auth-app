        ...
        <>
            <View style={styles.header}>
                ...
                <View style={styles.wrapContentHeader}>
                    <Text style={{color: 'white',fontSize: 41, fontWeight: 600, marginBottom: 14}}>Register</Text>
                    <Text style={{color: 'white', fontSize: 20, marginBottom: 24}}>Create your account</Text>
                </View>
            </View>
